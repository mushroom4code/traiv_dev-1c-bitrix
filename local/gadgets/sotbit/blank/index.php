			...
			<form method="post" action="" enctype="multipart/form-data" novalidate class="box">
				<div class="blank_excel_in_form">
					<div class="box__input">
						...
						<label for="file"><strong><?=Loc::getMessage('GD_SOTBIT_CABINET_BLANK_CHOOSE_FILE')?></strong><span class="box__dragndrop"> <?=Loc::getMessage('GD_SOTBIT_CABINET_BLANK_MOVE')?></span>.</label>
						<button type="button" class="box__button"><?=Loc::getMessage('GD_SOTBIT_CABINET_BLANK_SEND')?></button>
					</div>
