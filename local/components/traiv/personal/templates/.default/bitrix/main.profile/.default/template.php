...
?>
<section id="content">
<div class="traiv-personal-profile-default">
    ...
    <div class="form">
        ...
        <form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>" enctype="multipart/form-data">
                    ...
                    <table>
                        <tr>
                            <td class="left">
                                ...
                                <input class="form-control" type="text" name="NAME" value="<?=$arResult["arUser"]["NAME"]?>" />
                            </td>
                        ...
                        <tr>
                            <td class="left">
                                <label>Телефон</label>
                                <input class="form-control input_tel" type="text" name="PERSONAL_PHONE" value="<?=$arResult["arUser"]["PERSONAL_PHONE"]?>" />
                            </td>
                        ...
                        <tr>
                            <td class="left">
                                ...
                                <input id="input-email" class="form-control" type="text" name="EMAIL" value="<?=$arResult["arUser"]["EMAIL"]?>" />
                            </td>
            ...
            <input class="traiv-orange-button" type="submit" name="save" value="Сохранить">
        </form>
    </div>
</div>
</section>