...
<div class="settings" rel="1">
    ...
    <label class="traiv-container-checkbox">
        ...
        <span class="label">Я согласен на обработку <a href="/politika-konfidentsialnosti/" class="c_link" style="color:#0d6efd;">персональных данных</a></span>
    </label>
<div class="btn-group-blue">
    <input class="btn btn--submit btn-blue submit-button w100 save-subscribe submit-lower-text" type="submit" name="Save" value="<?echo ($arResult["ID"] > 0? GetMessage("subscr_upd"):GetMessage("subscr_add"))?>" />
    </div>
