    ...
    <div class="row g-0 d-flex align-items-center h-100">
        ...
        <div class="col-6 text-right">
            <div class="btn-group-blue">
            	<a href="#" class="btn-404 delete_all">
...
if(!empty($arItem["IMG"]))
{
    ...
    <img src="<?=$arItem["IMG"]?>" alt="<?=$formatedname?>" id="<?=$arItem["ID"]?>"/>
<?
}
?>
</a></div>
    ...
    <div class="col-7 col-xl-4 col-lg-3 col-md-3"><a href="<?=$arItem["URL"]?>" style="font-size:14px;padding-right:20px;"><?=$formatedname?></a></div>
    <div class="col-2 col-xl-1 col-lg-1 col-md-1 text-center"><span><?=$arItem["ARTICLE"]?></span></div>
    <div class="col-1 col-xl-1 col-lg-1 col-md-1 text-center d-none d-lg-block"><?=$arItem["WEIGHT"]?> гр.</div>
            ...
            <div class="col-4 col-xl-1 col-lg-1 col-md-1 text-center">
                ...
                <input type="text" name='QUANTITY' class="quantity section_list" id="<?= $item["ID"]?>-item-quantity"  size="5" value="<?=$arItem["QUANTITY"]?>" step="<?=$arItem["PACK"]?>" min="<?=$arItem["PACK"]?>">
            ...
            <div class="col-4 col-xl-1 col-lg-1 col-md-1 text-right text-md-center text-sm-center text-xl-center cart-remove-block">
            	<a href="#" title="Удалить товар" class="lk-cart-item-del"><i class="fa fa-close"></i></a>
            </div>
    </div>
</div>        
    ...
    <div class="row d-flex align-items-center">
        ...
        <div class="col-12 col-xl-5 col-lg-5 col-md-5 text-center text-lg-right">	
        	<div class="btn-group-blue"><a href="#buy-one-click" class="btn-blue btn-one-click" rel="nofollow"><span>Купить в 1 клик</span></a></div>
        </div>
