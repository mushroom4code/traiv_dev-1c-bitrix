...
if(count($arResult['ITEMS'])){
    ...
    <div class="col-12 d-none d-lg-block" id="catalog-list-line-th">
    	<div class="row g-0">
            <div class="col-2 col-xl-2 col-lg-2 col-md-2 text-center">Фото</div>
            <div class="col-4 col-xl-4 col-lg-4 col-md-4">Наименование</div>
    ...
    <div class="row traiv-catalog-line-default g-0 loadmore_wrap">
        ...
        <div class="row g-0">
            <div class="col-3 col-xl-2 col-lg-2 col-md-2 text-center">
...
{
    $picturl = CFile::ResizeImageGet($item['DETAIL_PICTURE'],array('width'=>50, 'height'=>50), BX_RESIZE_IMAGE_PROPORTIONAL, true);?><img src="<?=$picturl['src']?>" alt="<?=$formatedname?>" id="<?=$item["ID"]?>" itemprop="image"/>
<?
}else{
    ...
    $rsElement1 = CIBlockSection::GetList(array(), array('ID' => $sect_id), false, array('ID', 'IBLOCK_SECTION_ID', 'PICTURE'));if($arElement1 = $rsElement1->Fetch()) {$pict = $arElement1['DETAIL_PICTURE']?$arElement['DETAIL_PICTURE']:$arElement1['PICTURE'];}$picturl = CFile::ResizeImageGet($pict,array('width'=>35, 'height'=>35), BX_RESIZE_IMAGE_PROPORTIONAL, true);?><img  src="<?= $picturl['src']?>" alt="<?= $formatedname?>" width="35" height="35" title="<?=$formatedname?>" id="<?=$item["ID"]?>" itemprop="image"/><?}?></a></div>
            ...
            <div class="col-7 col-xl-4 col-lg-4 col-md-4" rel="<?php echo $sect_id;?>"><a href="<?= $item['DETAIL_PAGE_URL'] ?>" rel="1111" style="font-size:14px;padding-right:20px;"><!-- <span class="test-quan"><?php echo $item['CATALOG_QUANTITY'];?></span>--></span><span itemprop="name"><?=$formatedname?>
            </span></a></div>
            <div class="col-2 col-xl-2 col-lg-2 col-md-2 text-center"><span><?php echo $item["PROPERTIES"]["ARTIKUL"]["VALUE"];?></span></div>
...
<!-- <a href="#w-form-one-click" class="btn new-item-line-buy opt"><div class="opt-btn-label">Запросить</div></a>--><?
            ...
            <div class="btn-group-blue">
                        <a data-href="<?= str_replace("index.php", "", $item['~ADD_URL']); ?>" class="btn-cart-round new-item-line-buy" data-ajax-order>
