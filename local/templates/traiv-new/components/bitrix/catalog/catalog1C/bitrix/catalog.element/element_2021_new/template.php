    ...
    <div class="row">
        ...
        ?>
				...
				<ul class="prod-tabs">
					...
					<li><a data-prodtab-num="7" href="#" data-prodtab="#prod-tab-7" rel="nofollow">Гарантия</a></li>
					<?php 
...
<?php 
        ...
        <a data-fancybox="iframe" onclick="ym(18248638,'reachGoal','getVideoItem'); return true;" class="prod-video-link" href="<?php echo $vlink;?>"><div class="prod-video-area"></div><iframe width="200" height="auto" src="<?php echo $vlink;?>"></iframe></a>
        </div>
...
<!-- Характеристики -->
    						...
    						<div class="prod-character" <?php echo $check_select_top;?> <?php echo $check_select;?> rel="this">
    						
    						                                <?php if(count($arResult['DISPLAY_PROPERTIES'])){ ?>
                                    <div class="prod-character-item-first">Характеристики:</div>
...
<!-- // Характеристики -->
					...
					<div class="prod-tab" id="prod-tab-3" style="height: 0px; display: block;">
                        ...
                        while($res = $db_list->GetNext())
                        {
                            ...
                            foreach ($res["UF_SERTIFICAT"] as $keyone):
                                ...
                                <div class="col-3"><div class="sert_item"  id="title_<?=$arResult["ID"]?>">
 ...
 <!-- Варианты доставки -->
					...
					<div class="prod-tab" id="prod-tab-7" style="height: 0px;">
					     <?
                            $APPLICATION->IncludeComponent(
                                "bitrix:main.include",
                                ".default",
...
<div class="prod-info-line g-0">
			...
			<div class="row">
			<div class="col-4">
			<img src="/images/media/uzbekistan-330495.png"/>
			</div>
			<div class="col-8">
			<span style="padding-top: 6px;display: inline-block;">Поздравляем, вы из Узбекистана! Для вас специальные условия!</span>
			</div>
			</div>
			</p>
...
<div class="prod-info-line g-0">
            ...
            <div class="col-7 text-center align-self-center">
            	<div class="btn-group-blue">
                        <a data-href="<?= $arResult['~ADD_URL'] ?>" id="buy" class="btn-cart-roundw new-item-line-buy" data-ajax-order-detail>
