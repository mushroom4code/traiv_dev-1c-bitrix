...
echo "<table cellpadding='3' cellspacing='3' border='1' style='font-size:12px;' id='table_size_list'>";
echo "<tr>";
echo "<td>-</td>";
        ...
        foreach($arrRSdiametrRes as $i2 => $j2) {
            ...
            if (array_key_exists($j2, $arrRS)) {
                ...
                if (in_array($l,$arrRS[$j2])) {
                    ...
                    $arFilterRs = array('IBLOCK_ID'=>"18",'SECTION_ID'=>$sectionID,'PROPERTY_MATERIAL_1'=>$materialID, 'ACTIVE'=>'Y',
                        array("LOGIC"=> "AND",
                        ...
                        if ($res_rows > 0) {
                            while($ar_result_inRs = $db_list_inRs->GetNext()){
                                ?>
                                <a class="item-rs-reslink" href="<?php echo $ar_result_inRs['DETAIL_PAGE_URL'];?>" rel="nofollow"><?php echo "М".$j2."x".$l;?></a>
                                <?php 
                            }
                        }
