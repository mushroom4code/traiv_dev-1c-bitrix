...
if (!empty($arResult['PROPERTIES']['CASE_ITEM']['VALUE'])){
    $arCaseItem = $arResult['PROPERTIES']['CASE_ITEM']['VALUE'];
}
...
<div class="col-12 col-xl-8 col-lg-8 col-md-8 p-xl-5 p-lg-5 p-md-5 text-left position-relative">
	...
	<div class="land-sm-title pt-2 pt-xl-5 pt-lg-5 pt-md-5"><?php echo $arResult['PROPERTIES']['UTP_NOTE']['VALUE'];?></div>
</div>
    ...
    <div class="container">
        <div class="row position-relative">
            <div class="col-12 col-xl-12 col-lg-12 col-md-12 pt-3 pb-3 p-xl-5 p-lg-5 p-md-5 text-left position-relative">
            	<div class="land-title-black"><?php echo $arResult['PROPERTIES']['UTP_TITLE']['VALUE'];?></div>
            </div>
		</div>
		...
		"START_FROM" => "0"
		 ...
		 <div class="row position-relative">
            <div class="col-10 col-xl-10 col-lg-10 col-md-10 text-left position-relative">
            	...
            	<?php echo $arResult['PROPERTIES']['UTP_P']['VALUE'];?>
            	</div>
            </div>
...
<div class="land-case-area" id="case-item">
	<div class="container">
        ...
        <div class="row position-relative">
<?php 
$db_list_in = CIBlockElement::GetList(array(), ['IBLOCK_ID' => 7, 'ID' => $arCaseItem, 'ACTIVE'=>'Y'], false,Array ("nTopCount" => 5));
...
<div class="prod-elem-content">
               ...
               <div class="prod-comment-form post-form slam-easyform" style="margin-top:20px;">
     ...
     <div class="check_type_pack"><i class="icofont icofont-warning-alt"></i>После получения заявки с Вами свяжется менеджер для уточнения деталей заказа.</div>
               ...
               $APPLICATION->IncludeComponent(
	"slam:easyform", 
	"traiv-prod-2021-provo", 
	array(
		"COMPONENT_TEMPLATE" => "traiv-prod-2021-provo",
		"FORM_ID" => "FORM12",
		...
		"FIELDS_ORDER" => "Размер изделия,Количество изделий,Ваш комментарий,Ваше Имя,Телефон для связи,Ваш E-mail,DOCS",
		"FORM_AUTOCOMPLETE" => "Y",
		"HIDE_FIELD_NAME" => "N",
		"HIDE_ASTERISK" => "N",
		...
		"CATEGORY__________________________________PLACEHOLDER" => "+7(999)999-99-99",
		...
		"CATEGORY________E-mail_TITLE" => "Ваш E-mail",
		"CATEGORY________E-mail_TYPE" => "text",
		"CATEGORY________E-mail_PLACEHOLDER" => "",
		"CATEGORY________E-mail_VALUE" => "",
		"CATEGORY________E-mail_IBLOCK_FIELD" => "FORM_Ваш E-mail"
	),
	false
);?>
