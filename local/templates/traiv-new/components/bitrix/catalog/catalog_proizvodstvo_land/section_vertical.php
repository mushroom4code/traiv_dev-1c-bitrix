    ...
    [
        ...
        'CNT_ACTIVE' => 'Y'
                   ...
                   /* if ( $USER->IsAuthorized() )
                    ...
                    $template = "production_items_list_line_land";
...
<div class="bottom_zakaz text-center col-12 col-xl-12 col-lg-12 col-md-12 mt-3">    
    <p>
     Заказать крепеж вы можете по телефону <a href="tel:88007072598">8 (800) 707-25-98</a>, по email: <a href="mailto:info@traiv-komplekt.ru">info@traiv-komplekt.ru</a> или заполнить форму
    </p>
    <div class="btn-group-blue mt-3">
                    <a href="#w-form" class="btn-blue">
                        <span>Оставить заявку на производство</span>
                    </a>
                </div>
    </div>
