...
<!-- // Характеристики -->
					...
					<div class="prod-tab-new" id="sert" style="height: auto; display: block;">
						...
						<div class="row">
    						<div class="col-12">
    							...
    							<div class="h1title-item"><span>Сертификаты</span></div>
					...
					<div class="h1title-item"><span>Доставка</span></div>
										     <?
 ...
 <!-- Варианты доставки -->
					...
					<div class="h1title-item"><span>Оплата</span></div>
					<?
                            $APPLICATION->IncludeComponent(
                                "bitrix:main.include",
                                ".default",
					...
					<div class="h1title-item"><span>Гарантия</span></div>
					     <?
                            $APPLICATION->IncludeComponent(
                                "bitrix:main.include",
                                ".default",
				...
				<p data-prodtab-num="6" class="prod-tab-mob" data-prodtab="#prod-tab-6">Размерная сетка</p>
					...
					<div class="h1title-item"><span>Все размеры</span></div>  
        ...
        <ul class="row d-flex">
            ...
            <div class="product-specs" style="display: none;">
                <div class="row">
                    ...
                    <?php
                    if(is_array($arResult['PROPERTIES']['standarts']['VALUE']) && count($arResult['PROPERTIES']['standarts']['VALUE'])>0){
