...
<section id="content">
	...
	"catalog_parents_left_menu_cut", 
	array(
		"ADD_SECTIONS_CHAIN" => "N",
		"CACHE_GROUPS" => "N",
		"CACHE_TIME" => "36000000",
		"CACHE_TYPE" => "A",
		"COMPONENT_TEMPLATE" => "catalog_parents_left_menu_cut",
		"COUNT_ELEMENTS" => "Y",
		"IBLOCK_ID" => "54",
		"IBLOCK_TYPE" => "catalog",
		"SECTION_CODE" => "",
...
<h1><span><?=$arSEO["ELEMENT_PAGE_TITLE"]?></span></h1>
</div>
                            <? 
                        } else { ?>
...
<div class="col-12 col-xl-10 col-lg-10 col-md-10">
<h1><span><?=$pageN ? $arSEO["ELEMENT_PAGE_TITLE"].' - Страница '.$pageN : str_replace('&lt;sub&gt;c&lt;/sub&gt;','',$arSEO["ELEMENT_PAGE_TITLE"])?></span></h1>
</div>
...
<?php 
            ...
            <?
            if(/*$section["DESCRIPTION"] && */!$isGetFilter && !$pageN && !empty($section["DESCRIPTION"])){?>
