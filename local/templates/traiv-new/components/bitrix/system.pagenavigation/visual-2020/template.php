...
<div class="bx_pagination_bottom">
    <div class="bx_pagination_section_two" style="display:none;">
            ...
            <div class="bx_pagination_page"><?
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            ?><a href="<?=$origPage ?>" title="<? echo GetMessage('nav_prev_title'); ?>">&#8592;</a><?
                        }
                        else
                        {
                            ?>&#8592;<?
                        ...
                        while($NavRecordGroup <= $arResult["NavPageCount"])
                        {
                            ...
                            {
                                ?><li><a href="<?=$origPage; ?>" title="<? echo $strTitle; ?>"><?=$NavRecordGroup?></a></li><?
                            }
                            else
                            {
