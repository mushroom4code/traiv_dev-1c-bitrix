...
else
{
	...
	*/
	...
	{
		?>
		<div class="row g-0 d-flex align-items-center h-100"><div class="col-12 text-left"><span class="lk-cart-list-count">У вас нет текущих заказов</span></div><div class="col-12 pt-3 pb-3 text-left"><div class="btn-group-blue"><a href="/catalog/" class="btn-404" rel="1"><span>Перейти в каталог</span></a></div></div></div>
...
<div class="col-12 d-none d-lg-block" id="catalog-list-line-th">
    	<div class="row g-0">
            <div class="col-2 col-xl-2 col-lg-2 col-md-2 text-center"><?=Loc::getMessage('SPOL_TPL_ORDER_NUMBER')?></div>
            <div class="col-2 col-xl-2 col-lg-2 col-md-2">Дата</div>
            ...
            <div class="col-3 col-xl-3 col-lg-3 col-md-3 text-center"><?=Loc::getMessage('SPOL_TPL_ALL_SUMM')?></div>
...
<div class="row traiv-catalog-line-default g-0">
        ...
        <div class="row g-0">
				...
				<div class="col-2 col-xl-2 col-lg-2 col-md-2 text-center"><?=$order['ORDER']['ACCOUNT_NUMBER']?></div>
				<div class="col-3 col-xl-2 col-lg-2 col-md-2"><?=$order['ORDER']['DATE_INSERT']->format($arParams['ACTIVE_DATE_FORMAT'])?></div>
				...
				<div class="col-2 col-xl-2 col-lg-2 col-md-2 d-none d-lg-block text-center">
				...
				<div class="col-3 col-xl-3 col-lg-3 col-md-3 text-center"><?=$order['ORDER']['FORMATED_PRICE']?></div>
			...
			<div class="btn-group-blue"><a href="/personal/orderview/<?php echo $order['ORDER']['ACCOUNT_NUMBER'];?>" alt="Подробнее о заказе" title="Подробнее о заказе" class="btn-blue"><span><i class="fa fa-eye"></i></span></a></div>
				</div>  
				        <?php 
				    }
				}
