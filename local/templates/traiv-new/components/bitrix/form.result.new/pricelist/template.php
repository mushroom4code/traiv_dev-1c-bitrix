...
<div class="row">
   ...
   */ ?>
    ...
    <td colspan="2" class="license">
        <label><span class="pricelist_checkbox"><input type="checkbox" name="license" checked="checked" required="required" /></span>Я соглашаюсь на обработку персональных данных в соответствии с<a href="/politika-konfidentsialnosti/" style="margin-left: 3px;">Политикой конфиденциальности</a></label>
    </td>
    <br>
    <br>
    ...
    <div class="text-center pt-2">
    	<input id="sendForm" type="submit" onclick="yaCounter18248638.reachGoal ('zakaz_price'); return true;" class="btn-blue submit-button submit-big-text" value="Отправить"/>
    </div>
    
</div>
<?=$arResult["FORM_FOOTER"]?>
<script src="/local/templates/traiv-new/js/pricelist.js"></script>
