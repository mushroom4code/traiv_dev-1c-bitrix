...
<ul class="crumbs">
	<li class="crumbs__item">
		<a href="/" class="crumbs__link large-font">
			Главная страница
		</a>
	...
	<li class="crumbs__item <?=$crumbClass?>">
		<? if(!$isLast){ ?>
			<a href="<?=$crumbHref?>" class="crumbs__link large-font"><?=$crumbTitle?></a>
		...
		<? }else{ 
		    ...
		    if ($crumbTitle == "Технический раздел") {
		        ...
		        echo "<h1 class='crumbs__link large-font'>".$crumbTitle."</h1>";
		    }
		...
		?>
		<span class="crumbs__link large-font"><?=$crumbTitle?></span>
		<? } ?>
