...
?>
<!--noindex-->
<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="basket_form" id="basket_form" style="width:0px;height:0px;overflow:hidden;position:relative;opacity:0;">
    ...
    <div id="basket_form_container">
        <div class="bx_ordercart <?=$templateData['TEMPLATE_CLASS']; ?>">
            ...
            <div class="container cart-slider">
                ...
                <table class="cart-inner"  id="basket_items" CELLPADDING="5">
                    ...
                    <td></td>
                        ...
                        <td class="text-center">Упаковка</td>
                        <td class="text-center">Итого (руб.)</td>
                    </tr>
                    </thead>
...
<?
                            ...
                            <tr class="cart__row" id="<?=$arItem["ID"]?>" data-product_id="<?= $arItem['PRODUCT_ID'] ?>">
                                ...
                                <td class="cart__col cart-item__image">
                                    ...
                                    ?>
                                    <div class="cart-img-area text-center"><img src="<?= $ResizedImg['src'] ?>" alt="<?= $arItem["NAME"] ?>" class="responsive"></div>
                                </td>
                                
                                <td class="item-name"><!-- <p class="item_index"><?=$index.'. '?></p>--> <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>"><?=$formatedname ?></a></td>
                                
                                <td class="cart__col cart-item__art text-center"><span><?php echo  $arItem["PROPERTY_CML2_ARTICLE_VALUE"];?></span></td>
                                ...
                                <td class="cart__col cart-item__qnty">
                                    <div class="item-counter">
                                        ...
                                        <a rel="nofollow" href="javascript:void(0);" onclick="setQuantity(<?= $arItem["ID"] ?>, <?= $arItem["MEASURE_RATIO"] ?>, 'up', <?= $useFloatQuantityJS ?>);" class="item-counter__btn item-counter__increase"> <i class="fa fa-plus"></i></i>
                                        </a>

                                    </div>
                                </td>

                                <td class="cart__col cart-item__pack">
                                ...
                                <td class="cart__col cart-item__price">
                                    ...
                                    <a class="btn-remove" rel="nofollow" onclick='goPageAjax("<?= str_replace("#ID#", $arItem["ID"],
                                        $arUrls["delete"]) ?>"); return false;' ><i class="fa fa-close"></i></a>
                                </td>
                            </tr>
                    ...
                    <div class="cart__row" id="basket_items_button_list">
                        ...
                        <div class="col-4">
                            ...
                            <span class="price-small-area">Сумма заказа:
                        ...
                        <div class="col-2 text-right">
                            <div class="btn-group-blue">
                                <a href="#buy-one-click" onclick="yaCounter18248638.reachGoal ('one_click_buy'); return true;" class="btn-blue btn-one-click" rel="nofollow">
                		...
                		<div class="col-2 text-right">
                            <div class="btn-group-blue">
                                <a href="/personal/cart/" class="btn-blue" rel="nofollow">
                ...
                <div class="col-2">
                <div class="btn-group-blue">
                    <a href="/personal/order/make/" class="btn-blue" rel="nofollow">
...
<table class="template-cart__row">
    ...
    <tr class="cart__row" id="template-cart__row" data-product_id="{product_id}">
        <td class="cart__col cart-item__image">
            <div class="cart-img-area text-center"><img data-src="{src}" alt="{name}" class="responsive"></div>
        </td>
        <td class="item-name">
            <!-- <p class="item_index">{index}</p>-->
                <a rel="nofollow" href="{href}">{name}</a>
        </td>
        <td class="cart__col cart-item__art text-center">
            <span>{art}</span>
        </td>
        <td class="cart__col cart-item__price">
        ...
        <td class="cart__col cart-item__qnty">
            <div class="item-counter">
                ...
                <a rel="nofollow" href="javascript:void(0);" onclick="setQuantity({ID}, {rat}, 'up', false);" class="item-counter__btn item-counter__increase"><i class="fa fa-plus"></i></a>
