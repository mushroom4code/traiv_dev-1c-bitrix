        ...
        <div class="bx_ordercart <?=$templateData['TEMPLATE_CLASS']; ?>">
            ...
            <div class="container cart-slider">
                ...
                <div class="row" id="basket_items">
                	...
                	<div class="col">Упаковка</div>
                	<div class="col">Итого (руб.)</div>
                </div>
                
                <div class="row" id="basket-content">
                	                    <? if ($normalCount > 0){
...
<?
                            ...
                            <div class="col-12 cart__row" id="<?=$arItem["ID"]?>" data-product_id="<?= $arItem['PRODUCT_ID'] ?>">
                                <div class="row">
                                <div class="col cart__col cart-item__image">
                                    <?
                                ...
                                <div class="col item-name"><p class="item_index"><?=$index.'. '?></p> <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>"><?=$formatedname ?></a></div>
                                
                                <div class="col cart__col cart-item__art"><span><?php echo  $arItem["PROPERTY_CML2_ARTICLE_VALUE"];?></span></div>
                                <div class="col cart__col cart-item__price" id="itemprice">
                                ...
                                <div class="col cart__col cart-item__qnty">
                                ...
                                <div class="col cart__col cart-item__price">
                                    <?If ($arItem["PRICE_FORMATED"] !== "0 руб."){?>
                    ...
                    <div class="cart__row" id="basket_items_button_list">
                        ...
                        <!-- <a href="#buy-one-click" onclick="yaCounter18248638.reachGoal ('one_click_buy'); return true;" class="btn btn-mfp-dialog" rel="nofollow">Купить в 1 клик</a>-->
                            <a href="#buy-one-click" class="btn btn-mfp-dialog" rel="nofollow">Купить в 1 клик</a>
