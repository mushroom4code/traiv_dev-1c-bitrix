...
<a href="<?=SITE_TEMPLATE_PATH?>/cutting/Traiv_KP_ri.docx" download target="_blank">
	<img src="<?=SITE_TEMPLATE_PATH?>/images/cat_cutting.jpg" style="padding-bottom:20px;"/>
</a>
...
<? endif; ?>
        ...
        <div class="row h-100">
    	<div class="col-lg-12 col-md-6 col-sm-12 mb-30 text-md-left text-center">
