...
<div class="news-detail">
         ...
         <?php                
         if (count($arResult["PROPERTIES"]["PDF_FILE"]["VALUE"]) > 0){
             ...
             ?>
             <div class="<?php echo $st;?>">
             <?php 
             foreach ($arResult["PROPERTIES"]["PDF_FILE"]["VALUE"] as $arFile){
                $arFileItem = CFile::GetFileArray($arFile);
                ?>
                
                <div class="btn-group-blue mt-3 mb-3 pl-2">
                        	<a href="<?= $arFileItem["SRC"] ?>" target="_blank" class="btn-404" onclick="ym(18248638,'reachGoal','get_offer'); return true;">
