...
$this->addExternalCss($templateFolder.'/bootstrap_custom.css');
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div class="row">
				<div class="col-xs-12" style="position: relative; padding-left: 48px;"><div class="icon-success"></div>
				<div>За оформление каждого заказа Мы начисляем бонусы.<br>
Для их получения необходимо быть Зарегистрированным на сайте! <a href="/reg/">Зарегистироваться</a>
</div></div></div></div>
				
					<div class="alert alert-danger" style="display:none"></div>
					//this comments<div data-type="informer" style="display:none"></div>
				</div>-->
				<!--	AUTH BLOCK	-->
	        ...
	        <div class="btn-group-blue-small"><a href="/personal/cart/" class="btn-blue-small"><span><i class="fa fa-shopping-cart"></i> Вернуться в корзину</span></a></div>							
							</div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
					</div>
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title col-sm-9">
							<span class="bx-soa-section-title-count"></span><?/*=$arParams['MESS_REGION_BLOCK_NAME']*/?>Тип плательщика
						</h2>
				...
				<div id="bx-soa-orderSave">
					...
					<a href="javascript:void(0)" style="margin:10px 0px" class="pull-right prod-add hidden-xs" data-save-button="true">
						<?=$arParams['MESS_ORDER']?>
					</a>
					</p>-->

					   <div class="needOperCallArea">
<div class="form-check form-switch">
  <input class="form-check-input" type="checkbox" id="needOperCall">
  <label class="form-check-label" for="needOperCall"><span class="need_oper_label">Мне нужна консультация</span></label>
</div>
</div>
