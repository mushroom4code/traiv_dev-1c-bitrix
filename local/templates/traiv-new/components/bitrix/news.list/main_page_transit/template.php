...
?>
        ...
        <?foreach($arResult['ITEMS'] as $arItem):?>
                	...
                	<div class="col-12 posts2-i" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
		...
		<?php 
		echo month3char_tr(substr($arItem["PROPERTIES"]["DATE_INSERT"]["VALUE"],3,2));
		?>
		</time>
		...
		<?php 
		echo month3char_tr(substr($arItem['DISPLAY_ACTIVE_FROM'],3,2));
		?>
		</time>
