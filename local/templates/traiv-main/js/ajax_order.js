(function(){
    $(document).ready(function(event) {
        ...
        $(document).on('click', '[data-ajax-order]', function(event){
            ...
            var basket = $('.image-basket');  //TODO to function, crear mess

            var clst = $('#'+id);

            var cart_offset = $(".image-basket").offset(); //координаты корзины
        ...
        BX.addCustomEvent(window, 'OnBasketChange', function(){
            $('#cart_total_summ').html($('#allSum_FORMATED').html());
