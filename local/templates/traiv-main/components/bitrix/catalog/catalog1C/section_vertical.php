...
<div class="content">
	...
	?>
        ...
        <aside class="aside" <?php echo $rel;?> rel="111">
        ...
        if ( $USER->IsAuthorized() )
        {
            if ($USER->GetID() == '3092' || $USER->GetID() == '1788') {
                echo "<div id='s_din_list'><a href='#' id='s_din_list_link'>Показать DIN</a><div id='s_din_list_res'></div></div>";
            }
        }
	...
	?>
                ...
                <div class='subsection'>
                  ...
                  /*  $APPLICATION->IncludeComponent(
                    ...
                    {
                        if ($USER->GetID() == '3092') {
                            $template = "items_list_line_2020_test";
                        }
                    }
