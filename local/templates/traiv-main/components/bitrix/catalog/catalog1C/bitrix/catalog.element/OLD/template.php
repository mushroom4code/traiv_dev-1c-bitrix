...
<div class="island">
    ...
    <div class="row">
            ...
            <div class="product-specs">
                <div class="row">
                    <div class="col x1d4 x1d1--m">
                        ...
                        <div class="product__image x1d3--s" >
                        ...
                        <? if ($arResult['DISPLAY_PROPERTIES']['DIAMETR_1']["VALUE"] && $arResult['DISPLAY_PROPERTIES']['STANDART']["VALUE"]):?>
                            <div class="analog_materials_block" style="display: none;">
                                ...
                                <div class="analog_materials">
                                    ...
                                    $arSelect = Array("ID", "NAME", "DETAIL_PAGE_URL", "DETAIL_PICTURE", "PROPERTY_610", "PROPERTY_604");
                                    ...
                                    while($ob = $res->GetNext())
                                    {
                                        ...
                                        If ($ob["PROPERTY_610_VALUE"] === $arResult['DISPLAY_PROPERTIES']['MATERIAL_1']["VALUE"] || $ob["PROPERTY_610_VALUE"] === $last610 || ($ob["PROPERTY_610_VALUE"] ===  $last610 && $ob["PROPERTY_604_VALUE"] <= $last604)) { //to do: make it work
                                            continue;
                                        } else {
                                            ?>
                                            <a class="analog-material enumid-<?= $ob["PROPERTY_610_ENUM_ID"]?>" href="<?= $ob["DETAIL_PAGE_URL"] ?>"><img src="<?=$analogpict["src"]?>" class="analog-materials-img"><div class="analog-material-value"><?= $materialname?></div></a>
                                        <? }

                                        $last604 = $ob["PROPERTY_604_VALUE"];
                                        $last610 = $ob["PROPERTY_610_VALUE"];
        ...
        <?php if($printPrice !== '0 руб.'){?>
            <a href="#w-form-one-click" class="form-one-click__btn">Оптовая цена</a>
...
<div id="Information" class="tabcontent" style="display: none; text-align: center">
    <?
