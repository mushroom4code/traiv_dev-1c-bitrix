...
<div class="left_catalog_menu">
    ...
    ?>
    <a href="<?=$arItem["LINK"]?>" class="item <?= $start_active;?>" rel="<?=$arItem["PARAMS"]["SECTION_ID"]?>"><i class="spriten sn-<?=$arItem["PARAMS"]["SECTION_ID"]?> <?= $start_active_icon;?>"></i><?=$arItem["TEXT"]?></a>
        <?php  
...
foreach ($arr_sub_item as $key=>$val){
    ...
    foreach ($arr_sub_item_help[$key]["FSEARCH"] as $key_help=>$val_help) {
        ...
        ?><span><a href="#" class="sub_item_content_help_link" data-help-name="<?php echo $data_help_name;?>"><i class="icofont icofont-spinner-alt-4"></i><?php echo $val_help;?></a></span>
    <?php 
    }
    ...
    foreach ($arr_sub_item_help[$key]["SSEARCH"] as $key_help=>$val_help) {
        $data_help_name = mb_strtolower($val_help);
        ?><span><a href="#" class="sub_item_content_help_link_second" data-help-name="<?php echo $data_help_name;?>"><i class="icofont icofont-spinner-alt-4"></i><?php echo $val_help;?></a></span>
    <?php 
    }
    ?>
