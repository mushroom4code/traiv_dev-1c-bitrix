...
<div class="subsection">
    <div class="text-aligner">
        <div class="text-aligner__cell">
            <h2 class="md-title md-title--blue">У нас часто покупают</h2>
        </div>
    </div>

    <ul class="row">
        <li class="col x1d3 x1d2--t x1--s">
            <div class="catalog-item">
                <div class="catalog-item__header">
                    <h4 class="catalog-item__title">
                        <a href="#">DIN 316 Болт призонный высокопрочный</a>
                    </h4>
                    <div class="catalog-item__state">В наличии</div>
                </div>

                <div class="catalog-item__image">
                    <a href="#"><img src="http://images.metalvis.ua/images/upload/anker_etkd.png"
                                     alt=""></a>
                </div>
                ...
                <div class="catalog-item__footer">
                    ...
                    <div class="u-pull-right">
                        Аналог:
                        <ul class="similar">
                            <li class="similar__item">ГОСТ 1491</li>
                            <li class="similar__item">ISO 1207</li>
                        </ul>
                    </div>
                </div>
