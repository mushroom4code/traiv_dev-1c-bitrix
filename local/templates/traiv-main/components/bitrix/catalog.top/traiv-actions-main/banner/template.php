           ...
           <? $rsElement = CIBlockElement::GetList(array(), array('ID' => $arItem['ID']), false, false, array('ID', 'IBLOCK_SECTION_ID'));
			...
			<div id="<? echo $strMainID; ?>" class="bx_slider_block<? echo ($boolFirst ? ' active' : ''); ?>" style="width: <? echo $strItemWidth; ?>%;">
				<div class="bx_slider_photo_container">
					...
					<a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_slider_photo_element" style="background:#fff url(<? echo $picturl; ?>) no-repeat center;" title="<? echo $imgTitle; ?>">
						<?
