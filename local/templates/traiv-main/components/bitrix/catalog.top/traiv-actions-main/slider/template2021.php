...
?><div id="<? echo $strContID; ?>" class="prod-related prod2-related">
    ...
    <ul class="slides">
        ...
        foreach ($arResult['ITEMS'] as $keyRow => $arOneRow)
        {
            ...
            <!-- <div id="<? echo $strRowID; ?>" class="bx_catalog_tile_slide <? echo ($boolFirst ? 'active' : 'notactive'); ?>"> -->
                ...
                {
                    ?><li class="prod-rel-wrap" id="<? echo $strRowID; ?>">
                   <?php 
                    ...
                    <? $rsElement = CIBlockElement::GetList(array(), array('ID' => $arItem['ID']), false, false, array('ID', 'IBLOCK_SECTION_ID'));
                    ...
                    <?!empty($arItem['DETAIL_PICTURE']['SRC']) ? $picturl = $arItem['DETAIL_PICTURE']['SRC'] : $picturl = $arItem['PREVIEW_PICTURE']['SRC'] ; ?>
                    ...
                    <div class="prod-rel">
                            ...
                            <!-- <a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL'].'/'; ?>" class="bx_catalog_item_images" style="background-image: url('<? echo $picturl; ?>')" title="<? echo $imgTitle; ?>">-->
<a href="<? echo $arItem['DETAIL_PAGE_URL'].'/'; ?>" class="prod-rel-img" id="<? echo $strMainID; ?>">
<img src="<? echo $picturl; ?>" alt="<? echo $formatedname; ?>">
                                ...
                                /*if ($arItem['LABEL'])
                                {$arItem['LABEL_VALUE'] = 'Распродажа<br>со склада'
                                    ?>
                                    <div class="bx_stick average left top" style="position: absolute;
    width: 109px;
    height: 70px;
    background: url(/local/templates/traiv-main/components/bitrix/catalog.top/traiv-actions-main/slider/images/ribbon6.png) left center no-repeat;
    z-index: 100;
    bottom: 5px;margin-left: 0px;" title="<? echo $arItem['LABEL_VALUE']; ?>"><? echo $arItem['LABEL_VALUE']; ?></div>
                                    <?
                                }*/
                                ?>
                            </a>
                            ...
                            <div class="prod-rel-z">
                            <a href="<? echo $arItem['DETAIL_PAGE_URL'].'/'; ?>" title="<? echo $formatedname; ?>"><? echo $formatedname; ?></a>
                            </div>
                            <div class="prod-rel-price"><div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price">
                                    <?
                                    echo "<b>";
                                    if (!empty($minPrice))
                                    {
                                        ...
                                        {
                                            echo $minPrice['PRINT_DISCOUNT_VALUE']. ' / шт.';
                                        }
                                        if ('Y' == $arParams['SHOW_OLD_PRICE'] && $minPrice['DISCOUNT_VALUE'] < $minPrice['VALUE'])
                                        {
                                            ?> <span><? echo $minPrice['PRINT_VALUE']. ' / шт.'; ?></span><?
                                        }
                                        $CustomOldPrice = number_format($minPrice["VALUE"]*1.3, 2);
                                        echo "</b>";
                                    }
                                    unset($minPrice);

                                    /*$CustomOldPrice = $arItem['PROPERTIES']['OLD_PRICE']['VALUE'];
                                    $CustomOldPrice = preg_replace("/\|RUB/"," руб.", $CustomOldPrice);*/
                                    if (!empty ($CustomOldPrice)){
                                    ?><p><s><? echo $CustomOldPrice. ' руб.';}?></s></p>
                                </div></div>
                            <?
                                ...
                                <div class="bx_catalog_item_controls">
                                    ...
                                    if ($arItem['CAN_BUY'])
                                    {
                                        ...
                                        <div class="prod-addwrap">
                                            <a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium prod-add" href="javascript:void(0)" rel="nofollow">
