    ...
    <div class="index-item-line" style="width: -webkit-fill-available;     width: -moz-available;   width: fill-available; text-align: center;">
        ...
        <div class="category-item" style="display: inline-block;vertical-align: top; width: 13em; height: 10em; margin: 0.25em 0.25em;">
            ...
            <a href="/poleznoe/sootvetstvie-din-gost-iso-so-skhemami/">
                ...
                <img alt="Соответствие DIN-ГОСТ-ISO" src="//opt-1289540.ssl.1c-bitrix-cdn.ru/upload/content/articles/din-gost-iso-perevod.png?154831977617859" style="max-width: 4em; margin-top: 1.5em">
            </a>
        </div>
        ...
        <div class="category-item" style="display: inline-block;vertical-align: top; width: 13em; height: 10em; margin: 0.25em 0.25em;">
            ...
            <a href="/poleznoe/ves-izdeliy-po-din/">
                ...
                <img alt="Вес изделий по DIN " src="//opt-1289540.ssl.1c-bitrix-cdn.ru/upload/content/articles/ves_din.png?154831977616345" style="max-width: 6em; margin-top: 1.5em">
            </a>
        </div>
...
<?php 
	        ...
	        if ($ar_res = $resItem->GetNextElement()) {
	            ...
	            if (!empty($arProps['FILE_OST_PDF']['VALUE'])){
	                ?>
	                <?php 	                
	                $arFile = CFile::GetFileArray($arProps['FILE_OST_PDF']['VALUE']);
	                ?>
	                <span><a href="<?php echo $arFile['SRC'];?>" class="din_download_link" target="_blank"><img class="ami-lazy loaded" src="/upload/adwex.minified/webp/02c/100/02cd8671c11171d5a7944ecaeb34a1ca.webp" data-src="/upload/adwex.minified/webp/02c/100/02cd8671c11171d5a7944ecaeb34a1ca.webp" data-was-processed="true" style="vertical-align: middle;
    margin-right: 5px;
    margin-bottom: 5px;"><!-- <i class="icofont icofont-file-pdf"></i>-->Скачать <?php echo $arResult['META_TAGS']['TITLE'];?> в формате PDF</a></span>
	            ...
	            if (!empty($arProps['FILE_OST_DOC']['VALUE'])){
	                ?>
	                <?php 	                
	                $arFile = CFile::GetFileArray($arProps['FILE_OST_DOC']['VALUE']);
	                ?>
