...
$userNameInputName = 'form_text_25';
$phoneInputName = 'form_text_28';
$textInputName = 'form_textarea_29';

$formClassAttribute = "class='js-validate'";
$formIDAttribute = "";
  ...
  <div class="form-control-row">
    <div class="col x1d2 x1d1--m form-control-row">
      <input
        ...
        value="<?=$arResult["arrVALUES"]["form_text_25"]?>" 
        class="form-control">
    </div>
    ...
    <div class="col x1d2 x1d1--m form-control-row">
      <input 
        ...
        name="<?=$phoneInputName?>" 
        value="<?=$arResult["arrVALUES"]["form_text_28"]?>"
    ...
    <div class="col x1d1 x1d1--m form-control-row">
      <input 
        ...
        placeholder="E-mail" 
        name="form_email_32" 
        value="<?=$arResult["arrVALUES"]["form_email_32"]?>" 
    ...
    <div class="col x1d1 x1d1--m form-control-row">
		<textarea
                ...
                name="<?=$textInputName?>"
                class="form-control"><?=$arResult["arrVALUES"]["form_textarea_29"]?></textarea>
    </div>
