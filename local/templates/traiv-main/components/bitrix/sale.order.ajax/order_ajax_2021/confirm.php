...
<? if (!empty($arResult["ORDER"])): ?>
		...
		<tr>
			...
			<div style="font-size: 20px;font-weight:bold;line-height:30px;">
				<?=Loc::getMessage("SOA_ORDER_SUC", array(
					"#ORDER_DATE#" => $arResult["ORDER"]["DATE_INSERT"]->toUserTime()->format('d.m.Y'),
	...
	<?
	if ($arResult["ORDER"]["IS_ALLOW_PAY"] === 'Y' && /*dkv*/1==2)
	{
	...
	{
		?>
		<br /><div style="text-align:center;"><?=$arParams['MESS_PAY_SYSTEM_PAYABLE_ERROR']?></div>
		<?
	}
	?>
