				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					...
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container">
							...
							<div class="col-xs-12 col-sm-3 text-right"><a href="/personal/cart/" class="bx-soa-tocart"><i class="icofont icofont-shopping-cart"></i><span style="padding-left: 3px;">Вернуться в корзину</span></a><a href="javascript:void(0)" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
					</div>
				<? endif ?>
