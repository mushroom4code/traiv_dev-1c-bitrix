...
<form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>" enctype="multipart/form-data" class="dashboard__col js-validate">
	...
	<div class="tabs__row">
		...
		<h4 class="sm-title">Личные данные</h4>

		<div class="form-control-row">
			<input type="text" placeholder="<?=GetMessage('NAME')?>" name="NAME"
				   class="form-control" value="<?=$arResult["arUser"]["NAME"]?>">
		</div>
		<div class="form-control-row">
			<input type="text" placeholder="<?=GetMessage('LAST_NAME')?>" name="LAST_NAME"
				   class="form-control" value="<?=$arResult["arUser"]["LAST_NAME"]?>">
		</div>
	</div>

	<div class="tabs__row">
		<h4 class="sm-title">Пароль</h4>
	...
	<div class="u-align-center">
		<button class="btn btn--submit" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>"  ><?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?></button>
