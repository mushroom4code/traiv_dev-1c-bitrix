...
<div class="col-12 col-xl-4 col-lg-4 col-md-4 posts2-i" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
		<a class="posts-i-img" href="<?=$arItem['DETAIL_PAGE_URL']?>">
		<?php 
		...
		<?php     
		    ...
		    ?>
		    <span style="background: url('<?=SITE_TEMPLATE_PATH?>/images/actions_zag.jpg')"></span>
		    <?php 
		}
		?>
		...
		?>
							...
							<?php 
					        if (isset($arItem["PROPERTIES"]["ACT_END"])){
					            ?>
					            <span class="posts-i-end">Акция завершена</span>
					            <?php 
					        }
					?>
