    ...
    <div class="row d-flex align-items-center">
        ...
        <div class="np-services-service col-12 col-lg-4 col-md-4 text-md-left text-center d-flex">
            ...
            <div class="np-services-content">
                ...
                <div class="np-services-item-note-mobile">Производим детали по чертежам, техническим заданиями и образцам</div>
                <div class="np-services-item-arrow"><i class="fa fa-angle-right"></i></div>
            </div>
        ...
        <div class="np-services-service col-12 col-lg-4 col-md-4 text-md-left text-center d-flex pt-lg-0 pt-md-0 pt-4">
            ...
            <div class="np-services-content">
                ...
                <div class="np-services-item-note-mobile">23 типа различных покрытий</div>
                <div class="np-services-item-arrow"><i class="fa fa-angle-right"></i></div>
            </div>
        ...
        <div class="np-services-service col-12 col-lg-4 col-md-4 text-md-left text-center d-flex pt-lg-0 pt-md-0 pt-4">
            ...
            <div class="np-services-content">
                ...
                <div class="np-services-item-note-mobile">Производство метизов по стандартам обеспечивает высокое качество продукции, соответствие требованиям безопасности</div>
                <div class="np-services-item-arrow"><i class="fa fa-angle-right"></i></div>
            </div>
