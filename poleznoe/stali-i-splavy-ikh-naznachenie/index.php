...
$APPLICATION->SetPageProperty("title", "Стали и сплавы, их назначение");
$APPLICATION->SetTitle("Стали и сплавы, их назначение");
?>	<section id="content">
		<div class="container">
...
<h1><span>Стали и сплавы, их назначение</span></h1>
</div>
</div>
...
<?
	...
	array(
		"AREA_FILE_SHOW" => "page",
		"AREA_FILE_SUFFIX" => "_stali-i-splavy-ikh-naznachenie",
		"EDIT_TEMPLATE" => "",
		"COMPONENT_TEMPLATE" => ".default"
	),
	false
