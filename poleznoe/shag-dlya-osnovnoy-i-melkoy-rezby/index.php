...
$APPLICATION->SetTitle("Шаг для основной и мелкой резьбы");
?>	<section id="content">
		<div class="container">
...
<h1><span>Шаг для основной и мелкой резьбы</span></h1>
</div>
</div>
...
<?
	...
	array(
		"AREA_FILE_SHOW" => "page",
		"AREA_FILE_SUFFIX" => "_shag-dlya-osnovnoy-i-melkoy-rezby",
		"EDIT_TEMPLATE" => "",
		"COMPONENT_TEMPLATE" => ".default"
	),
	false
