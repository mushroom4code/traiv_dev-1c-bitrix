...
$APPLICATION->SetPageProperty("description", "Таблица соответствия диаметра и длинны к весу DIN 7982 шурупа самонарезающего с потайной головкой");
$APPLICATION->SetTitle("Вес по din 7982: шуруп самонарезающий с потайной головкой");
?>	<div class="content">
		<div class="container">
