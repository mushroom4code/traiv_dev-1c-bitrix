...
<section id="np-main-page-main">
 	<div class="container mt-5">
 		<div class="row">
 			...
 			<div class="col-12 col-lg-6 col-md-6 text-md-left text-center h-100">
         		...
         		<div class="row d-flex align-items-center h-100 position-relative" style="z-index:25;">
             				...
             				<div class="col-8 col-lg-8 col-md-8 offset-lg-1 text-md-left text-center">
								...
								<div class='np-slogan-title'><span>Производство и комплексные услуги для промышленных предприятий</span></div>
         			...
         			<div class="col-12 col-lg-12 col-md-12 text-md-left text-center">
             			<div class='np-main-item bordered b1 position-relative' style='background: url(/local/templates/traiv-new/images/np/np_edu_center_bann1.jpg) no-repeat center center;background-size:cover;height:250px;'>
             			<div class="np-edu-center-shape"></div>
             				<div class="row d-flex align-items-center h-100 position-relative" style="z-index:25;">
             				
             				<div class="col-7 col-lg-7 col-md-7 offset-lg-5 text-md-left text-center">
             				<div class="d-flex align-items-center position-relative mb-2"><img src="<?=SITE_TEMPLATE_PATH?>/images/np/np-edu-book1.png" style="width:75px;"/>
 				 ...
 				 <div class='np-main-item bordered b1' style='background: url(/local/templates/traiv-new/images/np/back_main.jpg) no-repeat center center;background-size:cover;height:100%;'>
 				 
 				 <img src="<?=SITE_TEMPLATE_PATH?>/images/np/np-main-page-main-figure11.png" class="np-main-page-main-figure" />
         				...
         				<div class="col-12 col-lg-12 col-md-12 text-md-left text-center">
         					<div class="np-main-htitle-area">
             					<div class="np-main-htitle-area-in">
             						<div class='np-htitle white'><span>Импортозамещение</span></div>
             						<div class='np-htitle-small white'><span>Интегрируем импортозамещение в ваше производство</span></div>
    							</div>
         					</div>
						</div>
				...
				<li><span class="import-title-cloud-item-main"><i class="fa fa-check-square-o"></i>Продукты металлообработки</span></li>
				<li><span class="import-title-cloud-item-main"><i class="fa fa-check-square-o"></i>Метизные изделия</span></li>
				<li><span class="import-title-cloud-item-main"><i class="fa fa-check-square-o"></i>Крепежные решения</span></li>
				<li><span class="import-title-cloud-item-main"><i class="fa fa-check-square-o"></i>Изделия по чертежам</span></li>
				<li><span class="import-title-cloud-item-main"><i class="fa fa-check-square-o"></i>Нанесение покрытий</span></li>
			</ul>
						</div>
						
						<div class="col-12 col-lg-12 col-md-12 text-md-left text-center" style="padding-left: 30px;">
							<div class="btn-group-blue mt-2"><a href="/about-company/" class="btn-blue-big"><span>Подробнее</span><i class="fa fa-long-arrow-right" style="padding-left:10px;"></i></a></div>
						</div>
...
<section id="np-main-page-directions">
 ...
 <section id="np_main_page_services">
       ...
       <div class="row d-flex align-items-center">
      	<div class="col-12 col-xl-12 col-lg-12 col-md-12 text-center mb-5"><div class='np-htitle'><span>Услуги</span></div></div>
      </div>
 	...
 	<div class="container">
 		<div class="row d-flex align-items-center h-100">
 			...
 			<div class="col-12 col-lg-7 col-md-7 text-left pl-5">
 				...
 				<div class="np-text pt-3"><p>Инновационная технологическая сервисная компания с индивидуальным подходом в производстве и разработке уникальных метизных решений.
Глубокая экспертиза и лабораторные испытания подтверждают высокое качество и прочность нашей продукции, соответствующей всем стандартам и нормам. Мы предлагаем надежную техническую документацию и IT-платформу для достижения лучших результатов наших клиентов. Трайв - Будущее в деталях!</p></div>

<div class="btn-group-blue mt-4"><a href="/about-company/" class="btn-blue-big"><span>Подробнее</span><i class="fa fa-long-arrow-right" style="padding-left:10px;"></i></a></div>
 			...
 			<div class="col-12 col-lg-5 col-md-4 text-left pl-5">
 				<a href="https://t.me/traivdirect" target="_blank" class="np-blink textup">Подписаться на Telegram <i class="fa fa-telegram"></i></a>
 			</div>
 ...
 <section id="main_page_category">
    <div class="container">
      ...
      <div class="row d-flex align-items-center">
      	<div class="col-12 col-xl-10 col-lg-10 col-md-10 mb-3"><div class="np-htitle black"><span>Изделия и покрытия в деталях - наше эксклюзивное портфолио</span></div></div>
      	<div class="col-2 d-none d-xl-block text-right"><a href="/catalog/" class="np_link_dashed_gray">Больше работ</a></div>
      </div>
	</div>
 		...
 		<div class="row">
 			<div class="col-12 col-lg-7 col-md-7 text-md-left text-center">
 				 <a href="#" class='np-main-item-portfolio bordered b1' style='background: url(/local/templates/traiv-new/images/np/portfolio1.png) no-repeat center center;background-size:cover;height:100%;'>
 				 <div class="np-main-item-portfolio-date"><span>01.10.23</span></div>
 				 <div class="np-main-item-portfolio-name"><span>Изготовление откидных болтов ГОСТ 3033</span></div>
 			...
 			<div class="col-12 col-lg-5 col-md-5 text-md-left text-center h-100">
     			<div class="row d-flex align-items-center h-100">
         			<div class="col-12 col-lg-12 col-md-12 text-md-left text-center mb-4">
             			<a href="#" class='np-main-item-portfolio bordered b1 position-relative' style='background: url(/local/templates/traiv-new/images/np/portfolio2.png) no-repeat center center;background-size:cover;height:150px;'>
             			<div class="np-main-item-portfolio-date"><span>01.10.23</span></div>
             			<div class="np-main-item-portfolio-name"><span>Производство болтов HP1.1A.2 </span></div>
             			</a>
         			</div>	 
         			
         			<div class="col-12 col-lg-12 col-md-12 text-md-left text-center">
         			<a href="#" class='np-main-item-portfolio bordered' style='background: url(/local/templates/traiv-new/images/np/portfolio3.png) no-repeat center center;background-size:cover;height:150px;'>
         			        <div class="np-main-item-portfolio-date"><span>01.10.23</span></div>
...
<div class="container">
      ...
      <div class="row d-flex align-items-center">
      	<div class="col-12 col-xl-12 col-lg-12 col-md-12 text-center"><div class='np-htitle'><span>Каталог готовых решений</span></div></div>
      </div>
	...
	if ($res_rows > 0) {
	    while($ar_result_inRs = $db_list_inRs->GetNext()){
	        ...
	        <div class="col-12 col-sm-4 col-md-4 col-lg-4 p-xl-3 p-lg-3 p-md-3 position-relative np-serv-slider-item">	        
    	        <a href="<?php echo '/services/proizvodstvo-metizov/works/'.$ar_result_inRs['CODE'];?>" class="np-serv-item bordered">
    	        
	                <time class="posts-i-date d-none" datetime="<?=$ar_result_inRs['DATE_ACTIVE_FROM'] ?>"><span><?=substr($ar_result_inRs['DATE_ACTIVE_FROM'],0,2) ?></span> 
		<?php 
		echo month2char(substr($ar_result_inRs['DATE_ACTIVE_FROM'],3,2));
		?>
		</time>
    	        
    	        		<div class="np-serv-slider-item-img" style="background-image:url(<?php echo $imgEl;?>);"></div>
 	...
 	<div class="container">
 		<div class="row d-flex align-items-center h-100">
 			...
 			<div class="col-12 col-lg-7 col-md-7 text-left pl-5">
 				...
 				<div class="np-text pt-3"><p>Наш учебный центр предлагает широкий спектр образовательных программ, от курсов повышения квалификации до профессиональной переподготовки.
 Мы работаем с опытными преподавателями, которые помогут вам освоить новые знания и навыки в комфортной обстановке.</p></div>
 ...
 <section id="main_page_category">
    <div class="container">
      ...
      <div class="row d-flex align-items-center">
      	<div class="col-12 col-xl-10 col-lg-10 col-md-10 mb-3"><div class="np-htitle black"><span>Производство и оптовые поставки крепежа</span></div></div>
      	<div class="col-2 d-none d-xl-block text-right"><a href="/catalog/" class="np_link_dashed_gray">Перейти в каталог</a></div>
      </div>
...
имеет возможность реализовать свой потенциал и достичь успеха в профессиональном росте. </span></div>
      	...
      	<div class="col-2 d-none d-xl-block text-right"><a href="/catalog/" class="np_link_dashed_gray"><img src="<?=SITE_TEMPLATE_PATH?>/images/np/hhru.jpg" style="width: 50px;position: absolute;
    left: -40px;
...
<div class="container">
 ...
 <div class="container">
       ...
       <div class="row d-flex align-items-center">
      	<div class="col-12 col-xl-12 col-lg-12 col-md-12 text-center"><div class='np-htitle'><span>Производственные мощности</span></div></div>
      </div>
     ...
     while($arData = $data->Fetch()){
		...
		//UF_NAME_STANOK
                            		        ...
                            		        <span href="#" class="np-mp-blink"><?php echo $arData['UF_NAME_STANOK'];?></span>
                                            	<a href="<?php echo $imgEl;?>" class="np-mp-photo-item bordered position-relative fancy-img" data-fancybox="gallery">
                                            		<div class="np-mp-photo-img text-center" style="background-image:url(<?php echo $imgEl;?>);"></div>
                                            	</a>
                                            </div>
                            		    <?php
                            		    //}
...
<div class="container">
    <div class="row">
    		...
    		<div class="row h-100">
    			...
    			<a href="/calculator/" class='np-quicklinks-item bordered'>
    				<div class='np-quicklinks-item-content'>
    					<img src="<?=SITE_TEMPLATE_PATH?>/images/quicklinks1.jpg" class="np-quicklinks-item-content-img"/>
    			...
    			<div class="col-lg-6 col-md-12 text-md-left text-center d-none">
    				...
    				<div class='np-quicklinks-item-content'>
    					<img src="<?=SITE_TEMPLATE_PATH?>/images/quicklinks9.jpg" class="np-quicklinks-item-content-img"/>
    					<div class="np-quicklinks-item-title">Каталог</div>
    					<p>Наш ассортимент товаров.</p>
    				</div>
    			</a>
    			</div>
        ...
        <div class="col-lg-7 col-md-6 col-sm-12 mb-30 text-md-left text-center">
        	<div class="row h-100">
	...
	<div class="np-callback-area">
		<div class="container fill">
			<div class="row d-flex align-items-center h-100 position-relative">
    			<div class="col-lg-8 col-md-12 text-md-left text-center position-relative h-100">
...
<div class="btn-group-blue mt-5"><a href="/about-company/" class="btn-blue-big"><span>Подробнее</span><i class="fa fa-long-arrow-right" style="padding-left:10px;"></i></a></div>
    			</div>
    </div>       
