...
<p>1.1. Настоящая Политика является неотъемлемой частью Публичной оферты (далее &ndash; &laquo;Оферта&raquo;), размещенной и/или доступной в сети Интернет по адресу: <a href="https://traiv-komplekt.ru/">https://traiv-komplekt.ru</a>, а также иных заключаемых с Пользователем договоров, когда это прямо предусмотрено их условиями.</p>
...
<p>1.3. Оператор имеет право вносить изменения в настоящую Политику. При внесенииизменений&nbsp;в заголовке Политики указывается дата последнего обновления редакции. Новая редакция&nbsp;Политики вступает в силу с момента ее размещения на сайте, если иное не предусмотрено новой&nbsp;редакцией Политики.</p>
...
<h2>7. Защита персонально информации Пользователя</h2>
...
<p>- по адресу электронной почты: info@traiv-komplekt.ru</p>

<p>- по почтовому адресу: 195176,РФ,г.Санкт-Петербург,Революции ш., д.31, лит.А</p>

<p>Дата публикации: 26.04.2019 г.</p>
