     ...
     if (!empty($_FILES["file_price"]["name"])) {
         ...
         if (move_uploaded_file($_FILES['file_price']['tmp_name'], $uploadfile) === false) {
             ...
             foreach($arr_new as $key=>$code) {
                 ...
                 $db_list_in = CIBlockElement::GetList(array(), ['IBLOCK_ID' => 18, "PROPERTY_CML2_TRAITS" => $code,'CATALOG_GROUP_ID' => 2], false, false, false);
                     ...
                     /*echo "<pre>";
                      ...
                      if (!empty($arFile['SRC'])){
                          ...
                          while($ar_group = $db_groups->Fetch()) {
                              ...
                              $getGroup = CIBlockSection::GetList(array(), array('ID' => $ar_group["ID"],"IBLOCK_ID"=>18), false, Array('UF_TAG_SECTION'));
