...
$(document).ready(function(){
   /* onOut();
    ...
    $('.webform-field-upload-notice:nth-child(2)').text('Ein Bild oder die Liste anzuhängen');
    $('.webform-field-upload-notice-small').text('Zulässige Dateieformate: png, jpg, pdf, xlsx, doc, docx, txt');
});
