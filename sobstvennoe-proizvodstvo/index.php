...
<div class="row">
    <div class="col-12 col-xl-12 col-lg-12 col-md-12">
    	<h1><span>Собственное производство</span></h1>
    </div>
</div>
...
<div class="row mb-3">
	<div class="col-6 col-xl-2 col-lg-2 col-md-2 text-center text-sm-left">
		<div class="btn-group-blue">
			<a href="<?=SITE_TEMPLATE_PATH?>/images/about_service.pdf" class="btn-i" download target="_blank">
...
<object><embed src="<?=SITE_TEMPLATE_PATH?>/images/about_service.pdf" width="100%" height="900" /></object>
