...
*/
    ...
    $('.webform-field-upload-notice:nth-child(2)').text('Attach Picture or Specification');
   $('.webform-field-upload-notice-small').text('Please chose one of the file-extentions: png, jpg, pdf, xlsx, doc, docx, txt');
