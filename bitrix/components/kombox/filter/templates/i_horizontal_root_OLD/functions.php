		...
		switch($arItem['SETTINGS']['VIEW'])
		{
			...
			?>
                ...
                <? if ($arItem['CODE_ALT'] !== 'standart'):?>
                    <a class="more" style="display: none; cursor: pointer;">Показать все</a><a class="less" style="display: none; cursor: pointer;">Скрыть</a>
                <? else:?>
                <a class="more standart" style="display: none; cursor: pointer;">Показать все</a><a class="less standart" style="display: none; cursor: pointer;">Скрыть</a>
				</div>
            <?//else:?>
