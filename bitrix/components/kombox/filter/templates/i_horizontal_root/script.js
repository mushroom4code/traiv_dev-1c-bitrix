...
let block = $('[data-name=standart]');
let text1 = 'DIN 7/ГОСТ 3128-70';
let text2 = 'ГОСТ 3128-70';
let replaced = block.html().replace(text1, text2);
block.html(replaced);
...
$('.more.standart').click(function() {
	...
	let btnHeight = $(this).parent().find('.lvl2').outerHeight(true);
	 ...
	 if (deli == 1){deli = deli*1.5};

	let colHeight = btnHeight * 1.5 * deli;
