...
<div id="<?echo $CONTAINER_ID?>" class="bx-searchtitle">
	<form action="<?echo $arResult["FORM_ACTION"]?>">
		<div class="bx-input-group search-top-area">
			...
			<span class="bx-input-group-btn">
				...
				<button class="" type="submit" name="s" style="height:35px;background: url(<?=SITE_TEMPLATE_PATH?>/images/new-search-icon.png) center center no-repeat !important;"></button>
			</span>
		</div>
	</form>
</div>
