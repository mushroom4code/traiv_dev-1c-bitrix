...
<div class="kzh-w-form-img col-12 col-lg-6 col-md-6 col-sm-6 x5d11 x1d1--md"><img src="/kazakhstan/img/w-form-banner-513x500.jpg"></div>
<div class="kzh-w-form-form col-12 x6d11 x1d1--md col-12 col-lg-6 col-md-6 col-sm-6">
<p class="kzh-w-form-title-one" rel="2">Haben Sie schon eine Liste von Befestigungs- und Montagematerialen?</p>
<p class="kzh-w-form-title-two">Füllen Sie das Formular aus und fügen Sie die Liste der gewünschten Befestigungselemente bei, falls Sie die haben. Wir werden uns in Kürze mit Ihnen in Verbindung setzen, um ein vorteilhaftes Angebot für die benötigten Befestigungs- und Montagematerialen zu besprechen.</p>
        ...
        <div class="row slam-row">
            ...
            if(!empty($arResult['FORM_FIELDS'])):
                foreach($arResult['FORM_FIELDS'] as $fieldCode => $arField):
                    ...
                    if($arField['TYPE'] == 'textarea'):?>
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <? endif; ?>
                                <div>
                                    <textarea class="form-control" id="<?=$arField['ID']?>" rows="1" name="<?=$arField['NAME']?>" <?= $arParams["FORMATED_NAME"] ? 'Меня интересует оптовая цена на '.$arParams["FORMATED_NAME"] :  $arField['PLACEHOLDER_STR'];?> <?=$arField['REQ_STR']?> maxlength="600"><?= $arParams["FORMATED_NAME"] ? 'Меня интересует оптовая цена на '.$arParams["FORMATED_NAME"] :  $arField['VALUE'];?></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <?elseif($arField['TYPE'] == 'file'):?>
                        <div class="file-upload-block col-xs-12">
                            <div class="form-group">
                                <? if(!$arParams['HIDE_FIELD_NAME']): ?>
                                 <!--   <label class="control-label" for="<?//=$arField['ID']?>"><?//=$arField['TITLE']?></label>  -->
                                <? endif; ?>
            ...
            <?endif;?>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                    <button type="submit" class="btn btn-primary submit-button" data-default="<?=$arParams['FORM_SUBMIT_VALUE']?>"><?=$arParams['FORM_SUBMIT_VALUE']?></button>
                    </div>
                    </div>
            <?endif;?>
        </div>
