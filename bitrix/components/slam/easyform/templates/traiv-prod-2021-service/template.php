                        ...
                        <!-- <div class="form-question">
                            <div class="form-group">-->
                                <?/* if(!$arParams['HIDE_FIELD_NAME']): */?><!--
                                    <label class="control-label" for="<?/*=$arField['ID']*/?>"><?/*=$arField['TITLE']*/?></label>
                                --><?/* endif; */?>
                                <input type="<?=$arField['TYPE'];?>" id="<?=$arField['ID']?>" name="<?=$arField['NAME']?>" value="<?=$arField['VALUE'];?>" placeholder="<?=$arField['TITLE'];?>" <?=$arField['REQ_STR']?> <?=$arField['MASK_STR']?>>
                            <!-- </div>
                        </div>-->
                    <?endif;
                endforeach;?>
