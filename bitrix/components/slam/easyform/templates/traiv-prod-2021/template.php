                ...
                foreach($arResult['FORM_FIELDS'] as $fieldCode => $arField):
                    ...
                    if($arField['TYPE'] == 'textarea'):?>
                        <div class="form-question">
                            <div class="form-group">
                                ...
                                <? endif; ?>
                                <div>
                                    <textarea class="form-control" id="<?=$arField['ID']?>" rows="5" name="<?=$arField['NAME']?>" <?=$arField['PLACEHOLDER_STR'];?> <?=$arField['REQ_STR']?> maxlength="600"><?=$arField['VALUE'];?></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <?elseif($arField['TYPE'] == 'file'):?>
                        <div class="form-question">
                            ...
                            <button type="submit" class="btn btn-primary pull-right submit-button col x1d2" onclick="yaCounter18248638.reachGoal ('proizvodstvo-metizov'); return true;" data-default="<?=$arParams['FORM_SUBMIT_VALUE']?>"><?=$arParams['FORM_SUBMIT_VALUE']?></button>
                        ...
                        <div class="form-question">
                            <div class="form-group">
                                <?/* if(!$arParams['HIDE_FIELD_NAME']): */?><!--
                                    <label class="control-label" for="<?/*=$arField['ID']*/?>"><?/*=$arField['TITLE']*/?></label>
                                --><?/* endif; */?>
                                <input class="form-control" type="<?=$arField['TYPE'];?>" id="<?=$arField['ID']?>" name="<?=$arField['NAME']?>" value="<?=$arField['VALUE'];?>" placeholder="<?=$arField['TITLE'];?>" <?=$arField['REQ_STR']?> <?=$arField['MASK_STR']?>>
                            </div>
                        </div>
                    <?endif;
                endforeach;?>
