...
<!-- <div class="slam-easyform<?=$arParams['HIDE_FORMVALIDATION_TEXT'] == 'Y' ? ' hide-formvalidation' : ''?>" <?=$WITH_FORM?>>-->
    ...
    <form id="<?=$FORM_ID?>"
        ...
        <div class="row">
            ...
            $arResult['FORM_FIELDS']['Ваш комментарий']['TYPE'] = 'textarea';
            ...
            if(!empty($arResult['FORM_FIELDS'])):
                foreach($arResult['FORM_FIELDS'] as $fieldCode => $arField):
                        ...
                        <!-- <div class="form-question">
                            <div class="form-group">
                                ...
                                <div class="col-12 col-xl-12 col-lg-12 col-md-12">
                                    <textarea id="<?=$arField['ID']?>" rows="5" name="<?=$arField['NAME']?>" placeholder="Ваш комментарий" <?=$arField['PLACEHOLDER_STR'];?> style="font-size:14px;margin: 0 0 20px 0;" <?=$arField['REQ_STR']?> maxlength="600"><?=$arField['VALUE'];?></textarea>
                                    </div>
                              <!--   </div>
                            </div>
                        </div>-->
                    ...
                    <?elseif($arField['TYPE'] == 'select'):?>
                        <div class="form-question switch-select">
                    ...
                    <div class="col-12 col-xl-12 col-lg-12 col-md-12">
                        <div class="form-question" style="padding-right:30px;">
                            <div class="form-group col x1d2" style="padding-left:0px;">
                                <? if(!$arParams['HIDE_FIELD_NAME']): ?>
                                 <!--   <label class="control-label" for="<?//=$arField['ID']?>"><?//=$arField['TITLE']?></label>  -->
                                <? endif; ?>
                            ...
                            <p class="warning-buy col x1"><small><?=$arResult['WARNING_MSG'];?></small></p>
                        </div>
                        </div>
                    <?else:?>
                    ...
                    <?php 
                            ...
                            if ($arField['ID'] == 'FORM12_FIELD_Размер изделия' || $arField['ID'] == 'FORM12_FIELD_Количество изделий'){
                                $class_style = "col-12 col-xl-6 col-lg-6 col-md-6";
                                $class_mask = "";
                                
                            } else if ($arField['ID'] == 'FORM12_FIELD_Телефон для связи'){
                                $class_mask = "prod_mask_phone";
                            } else {
                                $class_style = "col-12 col-xl-12 col-lg-12 col-md-12";
                                $class_mask = "";
                            }
                        ...
                        <!-- <div class="form-question">
                            <div class="form-group">-->
                                <?/* if(!$arParams['HIDE_FIELD_NAME']): */?><!--
                                    <label class="control-label" for="<?/*=$arField['ID']*/?>"><?/*=$arField['TITLE']*/?></label>
                                --><?/* endif; */?>
                                <input type="<?=$arField['TYPE'];?>" class="<?php echo $class_mask;?>" id="<?=$arField['ID']?>" name="<?=$arField['NAME']?>" value="<?=$arField['VALUE'];?>" placeholder="<?=$arField['TITLE'];?>" <?=$arField['REQ_STR']?> <?=$arField['MASK_STR']?>>
                            <!-- </div>
                        </div>-->
                        </div>
                    <?endif;
                    ...
                    <!-- <div class="form-question">
                        <div class="form-group"> -->
                         <div class="col-12 col-xl-12 col-lg-12 col-md-12">
                            ...
                            <? endif; ?>
                            <!-- <input id="<?=$FORM_ID?>-captchaValidator"  class="form-control" type="text" required data-bv-notempty-message="<?=GetMessage("SLAM_REQUIRED_MESS");?>" name="captchaValidator" style="border: none; height: 0px !important; padding: 0; visibility: hidden;">-->
                ...
                <div class="form-question">
                    ...
                    <?endif;?>
                    <!--<p class="min-summ-warning"><?/*=Loc::getMessage('SLAM_EASYFORM_MIN_SUMM')*/?></p>-->

                </div>
            <?endif;?>
        <!-- </div> -->
        
        <div class="prod-comment-submit" style="margin-bottom:20px;">
                            <button type="submit" class="btn-blue submit-button submit-big-text w100" onclick="yaCounter18248638.reachGoal ('proizvodstvo-metizov'); return true;" data-default="<?=$arParams['FORM_SUBMIT_VALUE']?>" value="Отправить">Отправить</button>
							</div>
        </div>
    </form>
