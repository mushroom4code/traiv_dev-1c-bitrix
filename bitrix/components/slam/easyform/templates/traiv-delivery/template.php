        ...
        <div class="row">
            ...
            if(!empty($arResult['FORM_FIELDS'])):
                ...
                <div class="col-xs-12">
                    ...
                    <button type="submit" class="btn btn-primary pull-right submit-button" onclick="yaCounter18248638.reachGoal ('delivery-payment'); return true;" data-default="<?=$arParams['FORM_SUBMIT_VALUE']?>"><?=$arParams['FORM_SUBMIT_VALUE']?></button>
                </div>
            <?endif;?>
        </div>
    </form>
