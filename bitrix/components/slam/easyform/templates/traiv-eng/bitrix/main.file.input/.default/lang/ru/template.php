...
$MESS["MFI_INPUT_CAPTION_ADD"] = "Select a file";
...
$MESS["MFI_NOTICE_1"] = "Select a file with an extension (#ext#) and a size that does not exceed #size#.";
$MESS["MFI_NOTICE_2"] = "Выберите файл с расширением (#ext#).";
$MESS["MFI_NOTICE_3"] = "Выберите файл, размер которого не превышает #size#.";
$MESS["MFI_NOTICE_4"] = "Attach your Bank details, competitive invoice, or other files";
?>