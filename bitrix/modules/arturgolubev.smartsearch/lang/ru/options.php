...
После изменения настроек на вкладке \"Настройка поиска\" необходимо сделать <a href=\"/bitrix/admin/search_reindex.php?lang=ru\" target=\"_blank\">полную переиндексацию поиска</a> (обязательно убрав галочку \"Переиндексировать только измененные\").
</div>";

$MESS["ARTURGOLUBEV_SMARTSEARCH_VISUAL_EXTENDED_NOTE"] = "<div style='text-align:left; width: 100%;'>
Настройки на этой вкладке применяются только к стандартным шаблонам решения. Если у вас установка поиска \"С сохранением дизайна\" данные настройки работать не будут (т.к. в этом случае используется ваш сохраненный шаблон, в котором нет поддержки таких настроек)<br/><br/>

Настройки \"Текст в поле ввода поискового запроса\", \"Показывать картинку раздела\", \"Показывать картинку раздела\" перенесены в настройки компонентов.
</div>";
...
$MESS["ARTURGOLUBEV_SMARTSEARCH_SORT_AVAILABLE_FIRST"] = "<span data-hint='Для корректной работы на элемент не должно действовать других правил сортировки'></span> Товары, доступные к покупке, приоритетнее чем недоступные:";
$MESS["ARTURGOLUBEV_SMARTSEARCH_SORT_AVAILABLE_QT_FIRST"] = "<span data-hint='Для корректной работы на элемент не должно действовать других правил сортировки'></span> Товары с положительным доступным количеством приоритетнее чем с нулевым:";
