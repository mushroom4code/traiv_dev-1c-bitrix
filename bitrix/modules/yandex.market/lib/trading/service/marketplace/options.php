...
class Options extends TradingService\Common\Options
{
	...
	public function usePushStocks()
	{
		return (
			...
			|| $this->getYandexMode() === static::YANDEX_MODE_PULL
		);
	}
	...
	protected function applyYandexMode()
	{
		...
		$this->values['YANDEX_MODE'] = static::YANDEX_MODE_PUSH;
	}
	...
	protected function getCommonFields(TradingEntity\Reference\Environment $environment, $siteId)
	{
		...
		$result['YANDEX_MODE'] = [
			...
			'HIDDEN' => Market\Config::isExpertMode() || $this->getYandexMode() !== static::YANDEX_MODE_PULL ? 'N' : 'Y',
			'MANDATORY' => 'Y',
