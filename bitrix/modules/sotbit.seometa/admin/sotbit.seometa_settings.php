...
$arOptions = array(
    ...
    'GENERATE_ALL_CONDITIONS' => array(
        ...
        'TITLE' => GetMessage( $module_id.'_GENERATE_ALL_CONDITIONS' ),
        'TYPE' => 'CHECKBOX',
        'REFRESH' => 'N',
        'SORT' => '25',
        'DEFAULT' => 'N',
        'NOTES' => GetMessage( $module_id.'_GENERATE_ALL_CONDITIONS_NOTE' ),
    ),
    ...
    'PARAMS_EXCEPTION_SETTINGS' => array(
        'GROUP' => 'GROUP_SETTINGS_FOR_PROG',
        'TITLE' => GetMessage( $module_id.'_PARAMS_EXCEPTION_SETTINGS' ),
        'TYPE' => 'TEXT',
        'REFRESH' => 'N',
        'SORT' => '150',
        'COLS' => 40,
        'ROWS' => 1,
        'DEFAULT' => "",
        'NOTES' => GetMessage( $module_id.'_PARAMS_EXCEPTION_SETTINGS_NOTE' ),
    ),
    ...
    'SEOMETA_SITEMAP_COUNT_LINKS_FOR_OPERATION' => array(
        'GROUP' => 'GROUP_SETTINGS_FOR_PROG',
        'TITLE' => GetMessage( $module_id.'_SITEMAP_COUNT_LINKS_FOR_OPERATION' ),
        'TYPE' => 'STRING',
        'REFRESH' => 'N',
        'SORT' => '150',
        'COLS' => 40,
        'ROWS' => 1,
        'DEFAULT' => "10000",
        'NOTES' => GetMessage( $module_id.'_SITEMAP_COUNT_LINKS_FOR_OPERATION_NOTE' ),
    ),
);
...
if(\Bitrix\Main\Loader::includeModule("currency")) {
    $arOptions['CURRENCY_TYPE'] = array(
        'GROUP' => 'GROUP_SETTINGS',
        'TITLE' => GetMessage( $module_id.'_CURRENCY_TYPE' ),
        'TYPE' => 'SELECT',
        'VALUES' => $arCurrencyTypes,
        'DEFAULT' => $baseCurrency,
        'REFRESH' => 'N',
        'SORT' => '30',
        'NOTES_ENUM' => GetMessage( $module_id.'_CURRENCY_TYPE_NOTE' ),
    );
}
