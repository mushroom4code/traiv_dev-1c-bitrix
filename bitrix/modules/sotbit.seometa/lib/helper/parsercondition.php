...
//                                $subFilter[$operator.'PROPERTY_'.$propertyId] = $value;
                            $subFilter[$operator.'PROPERTY_'.$propertyId.'_VALUE'] = $value;
                        }
                        else
                        {
                            if(intval($propertyId) == $propertyId) {
                                $property = \CIBlockProperty::GetByID($propertyId, $iblock)->fetch();
//                                    $propertyCode = \CIBlockProperty::GetByID($propertyId, $iblock)->fetch()['CODE'];
                                ...
                                switch ($property['PROPERTY_TYPE']) {
                                    case 'N':
                                        foreach ($value as $index => $val) {
                                            ...
                                            $result[$operator . 'PROPERTY_' . $property['CODE']] = $val;
                                        }
                                        break;
                                    case 'S':
                                        $result[$operator . 'PROPERTY_' . $property['CODE']] = $value;
                                        break;
                                    case 'E':
                                        $result[$operator . 'PROPERTY_' . $property['CODE'] . '.NAME'] = $value;
                                        break;
                                    default:
                                        $result[$operator . 'PROPERTY_' . $property['CODE'] . '_VALUE'] = $value;
                                }
                            }
                        }
                    }
