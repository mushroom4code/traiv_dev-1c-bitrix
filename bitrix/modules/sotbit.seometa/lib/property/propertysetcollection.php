...
class PropertySetCollection extends Iterator {

    public function addSet(PropertySet $propertySet) {
        $this->data[] = $propertySet;
    }

    public function filter(PropertyCollection $propertyCollection) {
