...
class Review
{
	...
	public function __construct($review = array())
	{
		...
		$this->setElement(new \Sotbit\Cabinet\Element());
	}
	...
	protected function changeLangMonth($date = '')
	{
		return str_replace(
			...
			array
			(
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_1'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_2'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_3'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_4'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_5'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_6'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_7'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_8'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_9'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_10'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_11'),
				Loc::getMessage('SOTBIT_CABINET_REVIEWS_MONTH_12'),
			), $date
		);
	}
