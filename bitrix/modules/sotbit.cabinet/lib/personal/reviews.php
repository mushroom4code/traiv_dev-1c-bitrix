 ...
 */
class Reviews extends \SotbitCabinet
{
	...
	public function getReviews()
	{
		if ($this->checkInstalledModules(array(
				'sotbit.reviews',
			)) && !\SotbitCabinet::getInstance()->isDemo())
		{
			$idElements = array();
			$linkReviewElement = Option::get('sotbit.reviews', 'REVIEWS_ID_ELEMENT_' . SITE_ID, 'ID_ELEMENT');
			$rsReviews = \Sotbit\Reviews\ReviewsTable::getList(array(
