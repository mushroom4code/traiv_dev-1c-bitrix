...
if(Loader::includeModule('sotbit.cabinet') && $idUser > 0)
{
	...
	foreach ($orders as $order)
	{
		...
		<div class="buyorder-cost">
			<span> <?=Loc::getMessage('GD_SOTBIT_CABINET_BUYORDER_SUM')?></span>
		...
		<div class="buyorder-info">
			<span><?=Loc::getMessage('GD_SOTBIT_CABINET_BUYORDER_DATE')?></span>
			<span><?=$order->getDate()->format("d.m.Y H:i:s")?></span>
		</div>

		<div class="buyorder-info">
			<span><?=Loc::getMessage('GD_SOTBIT_CABINET_BUYORDER_PERSON_TYPE')?></span>
