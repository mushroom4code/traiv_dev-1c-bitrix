...
$arAllOptions[] = Array(
    ...
    array("CACHE_INCLUDES_RULES", GetMessage("S2U_CACHE_INCLUDES_RULES") . " ", array("checkbox")),
...
foreach ($sites as $key => $value) {
    ...
    $arAllOptions[$key][] = array("REDIRECTS_IS_ACTIVE_$key", GetMessage("S2U_REDIRECTS_IS_ACTIVE") . " ", array("select", array(
        '' => GetMessage('S2U_REDIRECTS_IS_ACTIVE_FROM_COMMON'),
        'N' => GetMessage('S2U_REDIRECTS_IS_ACTIVE_N'),
    )),);
    
    $arAllOptions[$key][] = array("www_redirect_$key", GetMessage("S2U_REDIRECTS_WWW") . " ", array("select", array(
        '' => GetMessage('S2U_REDIRECTS_NO_REDIRECT'),
        'www' => GetMessage('S2U_REDIRECTS_WWW_TO_WWW'),
        'no-www' => GetMessage('S2U_REDIRECTS_WWW_TO_NOWWW'),
    )),);
    
    $arAllOptions[$key][] = array("https_redirect_$key", GetMessage("S2U_REDIRECTS_HTTPS") . " ", array("select", array(
        '' => GetMessage('S2U_REDIRECTS_NO_REDIRECT'),
        'https' => GetMessage('S2U_REDIRECTS_WWW_TO_HTTPS'),
        'http' => GetMessage('S2U_REDIRECTS_WWW_TO_HTTP'),
    )),);
    ...
    $arAllOptions[$key][] = array("double_slashes_fix_". $key, GetMessage("atl_autoredirects_double_slashes_fix"), array("checkbox"));
...
//if (count($arMsg)) {
if(is_array($arMsg) && count($arMsg)>0){
...
?>
    ...
    foreach ($sites as $key => $value) {
        ...
        echo '<tr><td colspan="2"><div class="adm-info-message">'.GetMessage('S2U_REDIRECTS_MAIN_MIRROR_NOTE').'</div></td></tr>';
        $tabControl->BeginNextTab();
    }
    ?>
