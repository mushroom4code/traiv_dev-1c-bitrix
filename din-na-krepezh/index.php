...
$APPLICATION->SetPageProperty("description", "DIN на крепеж");
$APPLICATION->SetPageProperty("title", "DIN на крепеж");
$APPLICATION->SetTitle("DIN на крепеж");
?>  <section id="content">
    <div class="container">
...
<div class="row">
 ...
 <div class="col-9">
         ...
         <?php if($APPLICATION->GetCurPage() == "/din-na-krepezh/") {
?>
<div class="row">
<div class="col-12 col-xl-12 col-lg-12 col-md-12">
<h1><span>DIN на крепеж</span></h1>
</div>
