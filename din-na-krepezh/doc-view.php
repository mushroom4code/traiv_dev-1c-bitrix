...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "board_pdf_din",
		"CONVERT_CURRENCY" => "N",
...
/*if ( $USER->IsAuthorized() )
{
   ...
   /* echo $_REQUEST["SECTION_CODE"];
    ...
    $arFilterRs = array('IBLOCK_ID'=>'45', '=CODE'=>$_REQUEST["ELEMENT_CODE"], 'ACTIVE'=>'Y');
    ...
    $db_list = CIBlockSection::GetList(array(), ['IBLOCK_ID'=>'45', 'CODE' =>  $_REQUEST["SECTION_CODE"], 'ACTIVE'=>'Y', 'GLOBAL_ACTIVE'=>'Y'], false,array());
    echo $res_rows1 = intval($db_list->SelectedRowsCount());
        if ($res_rows1 > 0) {
            while($ar_result = $db_list->GetNext()){
                ...
                $ipropValues = new \Bitrix\Iblock\InheritedProperty\SectionValues('45',$ar_result['ID']);
